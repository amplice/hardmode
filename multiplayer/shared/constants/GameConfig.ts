...
export const CHARACTER_ATTACKS = {
  ...
  hunter_primary: {
    ...
    hitboxType: 'projectile' as const,
...
export const CharacterClass = {
  BLADEDANCER: 'bladedancer' as const,
  GUARDIAN: 'guardian' as const,
  HUNTER: 'hunter' as const,
...
export const MonsterType = {
  ...
  GHOUL: 'ghoul' as const,
  WILDARCHER: 'wildarcher' as const
} as const;
