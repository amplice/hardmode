...
export class SharedWorldGenerator {
    ...
    private generateDecorativeElements(biomeData: number[][], elevationData: number[][]): any[][] {
        ...
        const snowDecorativeTypes = [
            ...
            { type: 'bush_snow1', width: 2, height: 2, weight: 0.5, walkablePattern: [[0,0],[1,1]] },
            { type: 'bush_snow2', width: 1, height: 2, weight: 0.5, walkablePattern: [[0],[1]] },
            { type: 'bush_snow3', width: 2, height: 2, weight: 0.5, walkablePattern: [[0,0],[1,1]] },
            { type: 'bush_snow4', width: 2, height: 2, weight: 0.5, walkablePattern: [[0,0],[0,1]] },
            { type: 'bush_snow5', width: 3, height: 2, weight: 0.5, walkablePattern: [[1,0,1],[0,0,1]] },
