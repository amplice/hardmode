...
export function createPlayerState(options) {
    ...
    if (typeof options.x !== 'number')
        throw new Error('Player x position is required');
    if (typeof options.y !== 'number')
        throw new Error('Player y position is required');
...
export function createMonsterState(options) {
    ...
    if (typeof options.x !== 'number')
        throw new Error('Monster x position is required');
    if (typeof options.y !== 'number')
        throw new Error('Monster y position is required');
...
export function createProjectileState(options) {
    ...
    if (!options.ownerId)
        throw new Error('Projectile owner ID is required');
    if (!options.position)
        throw new Error('Projectile position is required');
    if (!options.target)
        throw new Error('Projectile target is required');
    if (typeof options.damage !== 'number')
        throw new Error('Projectile damage is required');
    return {
        id: options.id,
...
export function createInputCommand(options) {
    if (!Array.isArray(options.keys))
        throw new Error('Input keys array is required');
    if (!options.facing)
        throw new Error('Input facing direction is required');
    if (typeof options.deltaTime !== 'number')
        throw new Error('Input deltaTime is required');
    if (typeof options.sequence !== 'number')
        throw new Error('Input sequence is required');
    return {
        keys: options.keys,
...
//# sourceMappingURL=EntityFactories.js.map