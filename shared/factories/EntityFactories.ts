...
const PLAYER_CLASS_STATS: Record<CharacterClass, { hitPoints: number; moveSpeed: number }> = {
...
export function createMonsterState(options: CreateMonsterOptions): MonsterState {
    // Validate required parameters
...
export function createProjectileState(options: CreateProjectileOptions): ProjectileState {
    // Validate required parameters
 ...
 */
export function createNetworkPlayerUpdate(playerState: PlayerState): NetworkPlayerUpdate {
