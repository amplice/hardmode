...
function buildPrompt({ compactData, preferences, sources, sourceStrategy, userFeedback, today }) {
  return [
    ...
    "",
    "Exported user feedback / positive and negative examples:",
    ...
    "- Treat exported user feedback with action \"exclude\" as strong negative examples. Avoid exact rejected rows and similar future rows unless clearly different or much higher value.",
    "- Treat exported user feedback with action \"include\" as strong positive examples. Prefer future rows with similar source, venue, category, genre, timing and notes.",
